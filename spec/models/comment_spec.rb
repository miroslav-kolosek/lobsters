...
describe Comment do
  ...
  describe ".accessible_to_user 2" do
    it "when user is a moderator" do
      moderator = build(:user, :moderator)
  ...
  describe ".accessible_to_user 3" do
    it "when user is a moderator" do
      moderator = build(:user, :moderator)
  ...
  describe ".accessible_to_user 4" do
    it "when user is a moderator" do
      moderator = build(:user, :moderator)
  ...
  describe ".accessible_to_user 5" do
    it "when user is a moderator" do
      moderator = build(:user, :moderator)
