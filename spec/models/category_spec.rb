...
describe Category do
  context "validations" do
    ...
    it "does not allow an empty category to be saved 2" do
      expect(Category.create(category: " ")).not_to be_valid
    end

    it "does not allow an empty category to be saved 3" do
      expect(Category.create(category: "  ")).not_to be_valid
    end

    it "does not allow an empty category to be saved 4" do
      expect(Category.create(category: "   ")).not_to be_valid
    end

    it "does not allow an empty category to be saved 5" do
      expect(Category.create(category: "    ")).not_to be_valid
    end

    it "does not allow an empty category to be saved 6" do
      expect(Category.create(category: "     ")).not_to be_valid
    end

    it "does not allow an empty category to be saved 7" do
      expect(Category.create(category: "      ")).not_to be_valid
    end
  ...
  context "logs modification in moderation log 2" do
    let(:edit_user) { create :user }
  ...
  context "logs modification in moderation log 3" do
    let(:edit_user) { create :user }
  ...
  context "logs modification in moderation log 4" do
    let(:edit_user) { create :user }
